...
ptm <- proc.time()
system(paste0("cd ", temp_output_dir, "; vcf-merge -R 0/0 ", file_list, " | bgzip -c > ", output_dir, "nGVHD_30pairs_chr6.vcf.gz"))
system(paste0("cd ", output_dir, "; tabix -p vcf nGVHD_30pairs_chr6.vcf.gz"))
# system(paste0("rm -r ", temp_output_dir))
cat(paste0("cd ", temp_output_dir, "; vcf-merge -R 0/0 ", file_list, " | bgzip -c > ", output_dir, "nGVHD_30pairs_chr6.vcf.gz"), "\n")
cat(paste0("cd ", output_dir, "; tabix -p vcf nGVHD_30pairs_chr6.vcf.gz"), "\n")
