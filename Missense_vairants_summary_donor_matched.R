...
#####
file_names <- all_vcf_files[grepl(paste0(all_groupIDs[paired_IDs],"_D_", collapse = "|"), all_vcf_files)] # 205 donors;recipients
...
save(donor_missense_stats, file = paste0(output_dir, "Matched_donor_missesense_stats_updated.RData"))