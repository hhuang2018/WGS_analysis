...
save(MatchedPair_IBD, file = paste0(IBD_segment_count_output_dir, 'MatchedPair_IBD_chr', chr,'.RData'))
rm(MatchedPair_IBD)
...
save(Random_DD_IBD, file = paste0(IBD_segment_count_output_dir, 'Random_DD_IBD_chr', chr,'.RData'))
rm(Random_DD_IBD)
...
save(Random_RD_IBD, file = paste0(IBD_segment_count_output_dir, 'Random_RD_IBD_chr', chr,'.RData'))
rm(Random_RD_IBD)
...
save(Random_RR_IBD, file = paste0(IBD_segment_count_output_dir, 'Random_RR_IBD_chr', chr,'.RData'))
rm(Random_RR_IBD)
