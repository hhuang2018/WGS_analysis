...
Matched_all_IBD_csv <- "Matched_IBD_segment.csv"
Random_all_IBD_csv <- "RandomPair_IBD_segment.csv"
aGVHD_all_IBD_csv <- "aGVHD_IBD_segment.csv"
nGVHD_all_IBD_csv <- "nGVHD_IBD_segment.csv"
