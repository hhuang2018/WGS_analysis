...
IBD_table <- read.table(file = "../Output/Beagle_output/aGVHD_10_pairs_ref.gt.ibd.ibd")
...
save(new_IBD_table, file = "../Output/IBD_test_info.RData")
write.csv(new_IBD_table, file = "../Output/IBD_test_table.csv", row.names = FALSE)