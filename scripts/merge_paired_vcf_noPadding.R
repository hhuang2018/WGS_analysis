...
for(id in 1:num_files){
  ...
  system(paste0("cd ", paired_vcf_dir,"; bcftools merge ",vcf_file_dir, Recipient_file," ",
                vcf_file_dir, Donor_file, ' -f "PASS" -O z > ', all_groupIDs[paired_IDs[id]], ".vcf.gz"))
  system(paste0("cd ", paired_vcf_dir, "; tabix -p vcf ", all_groupIDs[paired_IDs[id]], ".vcf.gz"))
  
  cat(paste0("cd ", paired_vcf_dir,"; bcftools merge ",vcf_file_dir, Recipient_file," ",
             vcf_file_dir, Donor_file, ' -f "PASS" -O z > ', all_groupIDs[paired_IDs[id]], ".vcf.gz"), "\n")
